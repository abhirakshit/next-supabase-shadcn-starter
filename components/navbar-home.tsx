...
// Types
export interface NavbarHomeNavItem {
  href?: string;
  label: string;
  submenu?: boolean;
...
export interface NavbarHomeProps extends React.HTMLAttributes<HTMLElement> {
  logo?: React.ReactNode;
  logoHref?: string;
  navigationLinks?: NavbarHomeNavItem[];
  ctaText?: string;
  ctaHref?: string;
  onSignInClick?: () => void;
  onCtaClick?: () => void;
...
export const NavbarHome = React.forwardRef<HTMLElement, NavbarHomeProps>(
  (
    {
      className,
      logo = <Logo />,
